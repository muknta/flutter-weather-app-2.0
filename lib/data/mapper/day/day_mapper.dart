...
class DayMapper {
  ...
  static Day fromTableModel(DayTableModel day) => Day(
        time: DateTime.fromMillisecondsSinceEpoch(day.time * 1000),
        sunrise: DateTime.fromMillisecondsSinceEpoch(day.sunrise * 1000),
        sunset: DateTime.fromMillisecondsSinceEpoch(day.sunset * 1000),
        weatherMain: day.weatherMain,
        weatherDesc: day.weatherDesc,
        weatherIconCode: day.weatherIconCode,
        dayTemp: day.dayTemp,
  ...
  static DayTableModel toTableModel(Day day) => DayTableModel(
  ...
  static Day fromJson(Map<String, dynamic> jsonData) => Day(
